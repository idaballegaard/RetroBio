...
<header class="py-6 px-6 border-b border-[#0b1220]">
  <div class="container mx-auto flex items-center justify-between">
    <div class="flex flex-col">
      <h1 class="text-2xl font-extrabold text-[var(--neon-yellow)]">Selected Movie Title</h1>
      <span class="text-sm text-gray-300">Duration • Genre • Year</span>
    </div>
    <div class="text-sm text-gray-300">Hall: <span class="font-semibold text-[#00e7ec]">1</span></div>
  </div>
</header>
      ...
      <section class="lg:col-span-2 panel p-6 rounded-xl">
        <div class="flex items-center justify-between mb-6">
          <div>
            ...
            <p class="text-sm text-gray-400">Time left: <span class="font-semibold text-white">13:47</span></p>
          </div>
          <div class="text-sm text-gray-400">Screen</div>
        </div>
        ...
        <div class="mb-6">
          ...
          <div id="seat-map" class="w-full flex flex-col items-center gap-3">
            <!-- We'll generate rows with JS for flexibility. -->
          </div>
