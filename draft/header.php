...
// Definer menupunkter i en array
$menuLinks = [
    'index.php' => 'Home',
    'movie.php' => 'Movies',
    'news.php' => 'News',
...
<nav class="custom-navbar bg-black border-b border-[#FFDF00]/50 fixed w-full z-20 top-0 left-0 shadow-lg">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="hidden md:flex items-center space-x-4">
        ...
        <?php else: ?>
            <a href="login.php" class="text-[#FFDF00] border border-[#FFDF00] px-3 py-1 rounded-lg hover:bg-[#FFDF00] hover:text-black transition-all">Login</a>
  ...
  <div id="mobile-menu" class="hidden md:hidden bg-black border-t border-[#FFDF00]/30 px-6 pb-4 space-y-2 slide-down">
    ...
    <?php else: ?>
        <a href="login.php" class="text-[#FFDF00] block mt-2 border border-[#FFDF00] px-3 py-1 rounded-lg hover:bg-[#FFDF00] hover:text-black transition-all">Login</a>
